...
The baselines root (the folder that contains copies/) comes from --baselines-root
or the LLAMAS_QA_BASELINES environment variable.
"""
import argparse
import csv
import glob
...
def main():
    parser = argparse.ArgumentParser(
        description="Copy-sort baseline cal MEF files from copies/ into per-type folders by PRODCATG.")
